...
│       │       ├── reader/
│       │       │   ├── ReadingScreen.kt        # serif body (Knuth-Plass orphan/widow, squared-off) + chrome/volume + highlight/lasso + bionic toggle + diagram + dictionary→vocabulary + true pages near progress + adaptive contrast toggle
