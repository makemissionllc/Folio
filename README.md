...
│       │       ├── reader/
│       │       │   ├── ReadingScreen.kt        # serif body + chrome/volume + highlight/lasso + bionic toggle + diagram + dictionary→vocabulary + true pages near progress + adaptive contrast toggle
